...
<h4 style="text-align:center;">Batch :- 2017 - 2021</h4>
  <p  style="text-align:center;">Sem - VIII</p>
  <div class="container">
  <div align="left" class="dropdown">
          <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Glance  </button>
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <a class="dropdown-item" href="sem8nb.php">All Clear</a>
          <a class="dropdown-item" href="sem8b.php">Backlog</a>
      </div><br>
...
$sql="SELECT * FROM `viii_sem` WHERE `COL 15` = 'F' ";
