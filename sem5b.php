...
<h4 style="text-align:center;">Batch :- 2017 - 2021</h4>
  <p  style="text-align:center;">Sem - V</p>
  <div class="container">
  <div align="left" class="dropdown">
          <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Glance  </button>
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <a class="dropdown-item" href="sem5nb.php">All Clear</a>
          <a class="dropdown-item" href="sem5b.php">Backlog</a>
      </div><br>
...
$sql="SELECT * FROM `v_sem` WHERE `COL 6` < 24 OR `COL 7` < 40 OR `COL 11` < 24 OR `COL 12` < 40 OR `COL 16` < 24 OR `COL 17` < 40 OR `COL 21` < 24 OR `COL 22` < 40 OR `COL 26` < 24 OR `COL 27` < 40 AND `COL 31` = 'F'";
