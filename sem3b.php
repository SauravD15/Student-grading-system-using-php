...
<h4 style="text-align:center;">Batch :- 2017 - 2021</h4>
  ...
  <p  style="text-align:center;">Sem - III</p>
  <div class="container">
  <div align="left" class="dropdown">
          <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Glance  </button>
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <a class="dropdown-item" href="sem3nb.php">All Clear</a>
          <a class="dropdown-item" href="sem3b.php">Backlog</a>
      </div><br>
...
$sql="SELECT * FROM `iii_sem_1` WHERE `COL 5` < 24 OR `COL 6` < 40 OR `COL 9` < 24 OR `COL 10` < 40 OR `COL 13` < 24 OR `COL 14` < 40 OR `COL 17` < 24 OR `COL 18` < 40 OR `COL 21` < 24 OR `COL 22` < 40 AND `COL 25` = 'F'";
