...
<div class="container">
    <button class="btn btn-primary my-5"><a href="add.php" class="text-light">Add Data</a>
    </button>
    <button class="btn btn-primary my-5"><a href="edit.php" class="text-light">Update</a>
    </button>
