...
$sql="SELECT * FROM `iv_sem` WHERE `COL 6` < 24 OR `COL 7` < 40 OR `COL 11` < 24 OR `COL 12` < 40 OR `COL 16` < 24 OR `COL 17` < 40 OR `COL 21` < 24 OR `COL 22` < 40 OR `COL 26` < 24 OR `COL 27` < 40 AND `COL 31` = 'F'";
