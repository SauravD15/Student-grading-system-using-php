...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container">
        <button class="btn btn-primary my-5"><a href="add.php" class="text-light">
              Add Data
        </a>
    </button>
...
if($result){
    while($row=mysqli_fetch_assoc($result)){
        ...
        <td>'.$COL_NO_29.'</td>
        <td>
        <button class="btn btn-danger"><a href="delete.php?deletecol='.$COL_NO_2.'" class="text-light">Delete</a></button>
        </td>
        </tr>';}
    }
?>   
